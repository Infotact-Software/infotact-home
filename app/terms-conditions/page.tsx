    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl mt-12">
      <Card>
        <CardHeader>
          ...
          <p className="text-muted-foreground">Last updated on Dec 24th 2024</p>
        </CardHeader>
        <CardContent className="prose prose-sm sm:prose lg:prose-lg dark:prose-invert">
          <p>
            For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall
            mean PITABAS PRADHAN, whose registered/operational office is Sampark Vihar, Patia, Bhubaneswar Khorda ODISHA
            751024. "you", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>
              ...
              services or information available through our website and/or product pages meet your specific
              requirements.
            </li>
            ...
            <li>
              Unauthorized use of information provided by us shall give rise to a claim for damages and/or be a criminal
              offense.
            </li>
            ...
            <li>
              You may not create a link to our website from another website or document without PITABAS PRADHAN's prior
              written consent.
            </li>

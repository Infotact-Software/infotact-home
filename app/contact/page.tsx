...
const page = () => {
      ...
      <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://pagedone.io/asset/uploads/1696245837.png')] ">
        <div className="">
          <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
            ...
            <img src="/white.png" alt="" className='h-32 w-32'/>
            </div>
            ...
            <div className="flex items-center justify-center border-t border-gray-100 pt-6">
              <a href="https://www.facebook.com/profile.php?id=61568978349528" className="mr-6" target='_blank'>
                <svg
                  width={31}
                  height={30}
                  viewBox="0 0 31 30"
              ...
              <a href="https://www.instagram.com/infotact_solutions/" className="mr-6" target='_blank'>
                <svg
                  width={31}
                  height={30}
                  viewBox="0 0 31 30"
              ...
              <a href="https://x.com/infotacts/" className="mr-6" target='_blank'>
                <svg
                  width={31}
                  height={30}
                  viewBox="0 0 31 30"
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.9699949895953!2d77.65759457483905!3d12.845214487458703!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae6dfd888c8a4f%3A0xc46e67f94081ed7b!2sInfotact%20Solutions!5e0!3m2!1sen!2sin!4v1737826525220!5m2!1sen!2sin"   loading="lazy" referrerPolicy="no-referrer-when-downgrade" className='w-full h-[60vh] mx-2 my-6'></iframe>
</section>

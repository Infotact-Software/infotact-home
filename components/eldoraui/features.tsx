                ...
                {data.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex items-center">
                      ...
                      <div>
                        <AccordionTrigger className="pl-0 text-xl font-bold open-sans-bold">
                          {item.title}
                        </AccordionTrigger>

                        <AccordionTrigger className="justify-start pl-0 text-left text-[16px] leading-4 open-sans-light">
                          {item.content}
                        </AccordionTrigger>
                      </div>
                    </div>

  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
      <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
        <img src="/white.png" alt="Pagedone" className="w-24" />
      ...
      <div className="lg:mx-auto text-left ">
        <h4 className="text-lg text-gray-900 font-medium mb-7">Infotact</h4>
      ...
      {/*End Col*/}
      <div className="lg:mx-auto text-left ">
        <h4 className="text-lg text-gray-900 font-medium mb-7">Careers</h4>
        <ul className="text-sm  transition-all duration-500">
          <li className="mb-6">
            <Link
              href="/verify"
    ...
    <div className="py-7 border-t border-gray-200">
      <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
        <span className="text-sm text-gray-500 ">
          ©<a href="https://pagedone.io/">Infotact</a> 2025, All rights
          reserved.
        </span>
        <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
          <a href='/msme.pdf' className="w-9 h-9 rounded-full  flex justify-center items-center " target='_blank'>
            <img src="/msme.png" alt="" className='h-auto w-24' />
            </a>
            <a href='/iso.pdf' className="w-9 h-9 rounded-full  flex justify-center items-center " target='_blank'>
            <img src="/iso.gif" alt="" className='h-auto w-24' />
            </a>
          <a
